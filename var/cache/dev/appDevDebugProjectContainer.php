...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            '1_9545a2f1d60ab75e8cf75c59804c8af8eb0ab4c05c11ecc552b63f5e38568f0a' => 'get19545a2f1d60ab75e8cf75c59804c8af8eb0ab4c05c11ecc552b63f5e38568f0aService',
            '2_9545a2f1d60ab75e8cf75c59804c8af8eb0ab4c05c11ecc552b63f5e38568f0a' => 'get29545a2f1d60ab75e8cf75c59804c8af8eb0ab4c05c11ecc552b63f5e38568f0aService',
            'annotation_reader' => 'getAnnotationReaderService',
            'annotations.reader' => 'getAnnotations_ReaderService',
            'app.markdown.extension' => 'getApp_Markdown_ExtensionService',
            'app.markdown_transformer' => 'getApp_MarkdownTransformerService',
            'app.twig.extension' => 'getApp_Twig_ExtensionService',
        ...
        $this->privates = array(
            '1_9545a2f1d60ab75e8cf75c59804c8af8eb0ab4c05c11ecc552b63f5e38568f0a' => true,
            '2_9545a2f1d60ab75e8cf75c59804c8af8eb0ab4c05c11ecc552b63f5e38568f0a' => true,
    ...
    /**
     * Gets the 'app.markdown.extension' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getApp_Markdown_ExtensionService()
    {
        return $this->services['app.markdown.extension'] = new \AppBundle\Twig\MarkdownExtension(${($_ = isset($this->services['app.markdown_transformer']) ? $this->services['app.markdown_transformer'] : $this->get('app.markdown_transformer')) && false ?: '_'});
    }
    ...
    /**
     * Gets the 'app.twig.extension' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getApp_Twig_ExtensionService()
    {
        return $this->services['app.twig.extension'] = new \AppBundle\Twig\AppExtension();
    }
    ...
    protected function getConfigCacheFactoryService()
    {
        return $this->services['config_cache_factory'] = new \Symfony\Component\Config\ResourceCheckerConfigCacheFactory(new RewindableGenerator(function () {
            yield 0 => ${($_ = isset($this->services['1_9545a2f1d60ab75e8cf75c59804c8af8eb0ab4c05c11ecc552b63f5e38568f0a']) ? $this->services['1_9545a2f1d60ab75e8cf75c59804c8af8eb0ab4c05c11ecc552b63f5e38568f0a'] : $this->get19545a2f1d60ab75e8cf75c59804c8af8eb0ab4c05c11ecc552b63f5e38568f0aService()) && false ?: '_'};
            yield 1 => ${($_ = isset($this->services['2_9545a2f1d60ab75e8cf75c59804c8af8eb0ab4c05c11ecc552b63f5e38568f0a']) ? $this->services['2_9545a2f1d60ab75e8cf75c59804c8af8eb0ab4c05c11ecc552b63f5e38568f0a'] : $this->get29545a2f1d60ab75e8cf75c59804c8af8eb0ab4c05c11ecc552b63f5e38568f0aService()) && false ?: '_'};
        }, 2));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = ${($_ = isset($this->services['doctrine.dbal.connection_factory']) ? $this->services['doctrine.dbal.connection_factory'] : $this->get('doctrine.dbal.connection_factory')) && false ?: '_'}->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'eventbrote', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    public function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['doctrine.orm.default_entity_manager'] = new DoctrineORMEntityManager_000000000069a828000000003a267c96d7b741fef339d0f77c2ca74ea7f7d8e4(
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_0d27f76bf887a873398957771a0ec5b96142f42e4ce5dd1858a322d7d1a5b17d');
    ...
    protected function getTwigService()
    {
        ...
        $this->services['twig'] = $instance = new \Twig\Environment(${($_ = isset($this->services['twig.loader']) ? $this->services['twig.loader'] : $this->get('twig.loader')) && false ?: '_'}, array('debug' => true, 'strict_variables' => true, 'date' => array('timezone' => 'Europe/Paris', 'format' => 'F j, Y H:i', 'interval_format' => '%d days'), 'exception_controller' => 'twig.controller.exception:showAction', 'form_themes' => array(0 => 'form_div_layout.html.twig'), 'autoescape' => 'name', 'cache' => (__DIR__.'/twig'), 'charset' => 'UTF-8', 'paths' => array(), 'number_format' => array('decimals' => 0, 'decimal_point' => '.', 'thousands_separator' => ',')));
        ...
        $instance->addExtension(${($_ = isset($this->services['app.markdown.extension']) ? $this->services['app.markdown.extension'] : $this->get('app.markdown.extension')) && false ?: '_'});
        $instance->addExtension(${($_ = isset($this->services['app.twig.extension']) ? $this->services['app.twig.extension'] : $this->get('app.twig.extension')) && false ?: '_'});
    ...
    /**
     * Gets the '1_9545a2f1d60ab75e8cf75c59804c8af8eb0ab4c05c11ecc552b63f5e38568f0a' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function get19545a2f1d60ab75e8cf75c59804c8af8eb0ab4c05c11ecc552b63f5e38568f0aService()
    {
        return $this->services['1_9545a2f1d60ab75e8cf75c59804c8af8eb0ab4c05c11ecc552b63f5e38568f0a'] = new \Symfony\Component\DependencyInjection\Config\ContainerParametersResourceChecker($this);
    }

    /**
     * Gets the '2_9545a2f1d60ab75e8cf75c59804c8af8eb0ab4c05c11ecc552b63f5e38568f0a' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function get29545a2f1d60ab75e8cf75c59804c8af8eb0ab4c05c11ecc552b63f5e38568f0aService()
    {
        return $this->services['2_9545a2f1d60ab75e8cf75c59804c8af8eb0ab4c05c11ecc552b63f5e38568f0a'] = new \Symfony\Component\Config\Resource\SelfCheckingResourceChecker();
    }
    ...
    public function getCache_App_RecorderInnerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['cache.app.recorder_inner'] = new SymfonyComponentCacheAdapterFilesystemAdapter_000000000069a846000000003a267c96d7b741fef339d0f77c2ca74ea7f7d8e4(
                function (&$wrappedInstance, \ProxyManager\Proxy\LazyLoadingInterface $proxy) {
        ...
        $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('vIy+rcjzMO', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.serializer.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('rfeOfTodbs', 0, 'NXW+zhwzBE0+i4dMCoruc7', (__DIR__.'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)) && false ?: '_'});
    }
    ...
    {
        return $this->services['cache.system.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Au33DN7vp3', 0, 'NXW+zhwzBE0+i4dMCoruc7', (__DIR__.'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)) && false ?: '_'});
    }
    ...
    {
        return $this->services['cache.validator.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('LX7UIiGlQT', 0, 'NXW+zhwzBE0+i4dMCoruc7', (__DIR__.'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)) && false ?: '_'});
    }
    ...
    {
        return $this->services['security.authentication.provider.anonymous.main'] = new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('59a7d755cdad06.33004413');
    }
...
class DoctrineORMEntityManager_000000000069a828000000003a267c96d7b741fef339d0f77c2ca74ea7f7d8e4 extends \Doctrine\ORM\EntityManager implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder59a7d75b4e9fd701837375 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer59a7d75b4ea32575752362 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties59a7d75b4e999026364405 = array(
    ...
    {
        $this->initializer59a7d75b4ea32575752362 && $this->initializer59a7d75b4ea32575752362->__invoke($this->valueHolder59a7d75b4e9fd701837375, $this, 'getConnection', array(), $this->initializer59a7d75b4ea32575752362);

        return $this->valueHolder59a7d75b4e9fd701837375->getConnection();
    }
    ...
    {
        $this->initializer59a7d75b4ea32575752362 && $this->initializer59a7d75b4ea32575752362->__invoke($this->valueHolder59a7d75b4e9fd701837375, $this, 'getMetadataFactory', array(), $this->initializer59a7d75b4ea32575752362);

        return $this->valueHolder59a7d75b4e9fd701837375->getMetadataFactory();
    }
    ...
    {
        $this->initializer59a7d75b4ea32575752362 && $this->initializer59a7d75b4ea32575752362->__invoke($this->valueHolder59a7d75b4e9fd701837375, $this, 'getExpressionBuilder', array(), $this->initializer59a7d75b4ea32575752362);

        return $this->valueHolder59a7d75b4e9fd701837375->getExpressionBuilder();
    }
    ...
    {
        $this->initializer59a7d75b4ea32575752362 && $this->initializer59a7d75b4ea32575752362->__invoke($this->valueHolder59a7d75b4e9fd701837375, $this, 'beginTransaction', array(), $this->initializer59a7d75b4ea32575752362);

        return $this->valueHolder59a7d75b4e9fd701837375->beginTransaction();
    }
    ...
    {
        $this->initializer59a7d75b4ea32575752362 && $this->initializer59a7d75b4ea32575752362->__invoke($this->valueHolder59a7d75b4e9fd701837375, $this, 'getCache', array(), $this->initializer59a7d75b4ea32575752362);

        return $this->valueHolder59a7d75b4e9fd701837375->getCache();
    }
    ...
    {
        $this->initializer59a7d75b4ea32575752362 && $this->initializer59a7d75b4ea32575752362->__invoke($this->valueHolder59a7d75b4e9fd701837375, $this, 'transactional', array('func' => $func), $this->initializer59a7d75b4ea32575752362);

        return $this->valueHolder59a7d75b4e9fd701837375->transactional($func);
    }
    ...
    {
        $this->initializer59a7d75b4ea32575752362 && $this->initializer59a7d75b4ea32575752362->__invoke($this->valueHolder59a7d75b4e9fd701837375, $this, 'commit', array(), $this->initializer59a7d75b4ea32575752362);

        return $this->valueHolder59a7d75b4e9fd701837375->commit();
    }
    ...
    {
        $this->initializer59a7d75b4ea32575752362 && $this->initializer59a7d75b4ea32575752362->__invoke($this->valueHolder59a7d75b4e9fd701837375, $this, 'rollback', array(), $this->initializer59a7d75b4ea32575752362);

        return $this->valueHolder59a7d75b4e9fd701837375->rollback();
    }
    ...
    {
        $this->initializer59a7d75b4ea32575752362 && $this->initializer59a7d75b4ea32575752362->__invoke($this->valueHolder59a7d75b4e9fd701837375, $this, 'getClassMetadata', array('className' => $className), $this->initializer59a7d75b4ea32575752362);

        return $this->valueHolder59a7d75b4e9fd701837375->getClassMetadata($className);
    }
    ...
    {
        $this->initializer59a7d75b4ea32575752362 && $this->initializer59a7d75b4ea32575752362->__invoke($this->valueHolder59a7d75b4e9fd701837375, $this, 'createQuery', array('dql' => $dql), $this->initializer59a7d75b4ea32575752362);

        return $this->valueHolder59a7d75b4e9fd701837375->createQuery($dql);
    }
    ...
    {
        $this->initializer59a7d75b4ea32575752362 && $this->initializer59a7d75b4ea32575752362->__invoke($this->valueHolder59a7d75b4e9fd701837375, $this, 'createNamedQuery', array('name' => $name), $this->initializer59a7d75b4ea32575752362);

        return $this->valueHolder59a7d75b4e9fd701837375->createNamedQuery($name);
    }
    ...
    {
        $this->initializer59a7d75b4ea32575752362 && $this->initializer59a7d75b4ea32575752362->__invoke($this->valueHolder59a7d75b4e9fd701837375, $this, 'createNativeQuery', array('sql' => $sql, 'rsm' => $rsm), $this->initializer59a7d75b4ea32575752362);

        return $this->valueHolder59a7d75b4e9fd701837375->createNativeQuery($sql, $rsm);
    }
    ...
    {
        $this->initializer59a7d75b4ea32575752362 && $this->initializer59a7d75b4ea32575752362->__invoke($this->valueHolder59a7d75b4e9fd701837375, $this, 'createNamedNativeQuery', array('name' => $name), $this->initializer59a7d75b4ea32575752362);

        return $this->valueHolder59a7d75b4e9fd701837375->createNamedNativeQuery($name);
    }
    ...
    {
        $this->initializer59a7d75b4ea32575752362 && $this->initializer59a7d75b4ea32575752362->__invoke($this->valueHolder59a7d75b4e9fd701837375, $this, 'createQueryBuilder', array(), $this->initializer59a7d75b4ea32575752362);

        return $this->valueHolder59a7d75b4e9fd701837375->createQueryBuilder();
    }
    ...
    {
        $this->initializer59a7d75b4ea32575752362 && $this->initializer59a7d75b4ea32575752362->__invoke($this->valueHolder59a7d75b4e9fd701837375, $this, 'flush', array('entity' => $entity), $this->initializer59a7d75b4ea32575752362);

        return $this->valueHolder59a7d75b4e9fd701837375->flush($entity);
    }
    ...
    {
        $this->initializer59a7d75b4ea32575752362 && $this->initializer59a7d75b4ea32575752362->__invoke($this->valueHolder59a7d75b4e9fd701837375, $this, 'find', array('entityName' => $entityName, 'id' => $id, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer59a7d75b4ea32575752362);

        return $this->valueHolder59a7d75b4e9fd701837375->find($entityName, $id, $lockMode, $lockVersion);
    }
    ...
    {
        $this->initializer59a7d75b4ea32575752362 && $this->initializer59a7d75b4ea32575752362->__invoke($this->valueHolder59a7d75b4e9fd701837375, $this, 'getReference', array('entityName' => $entityName, 'id' => $id), $this->initializer59a7d75b4ea32575752362);

        return $this->valueHolder59a7d75b4e9fd701837375->getReference($entityName, $id);
    }
    ...
    {
        $this->initializer59a7d75b4ea32575752362 && $this->initializer59a7d75b4ea32575752362->__invoke($this->valueHolder59a7d75b4e9fd701837375, $this, 'getPartialReference', array('entityName' => $entityName, 'identifier' => $identifier), $this->initializer59a7d75b4ea32575752362);

        return $this->valueHolder59a7d75b4e9fd701837375->getPartialReference($entityName, $identifier);
    }
    ...
    {
        $this->initializer59a7d75b4ea32575752362 && $this->initializer59a7d75b4ea32575752362->__invoke($this->valueHolder59a7d75b4e9fd701837375, $this, 'clear', array('entityName' => $entityName), $this->initializer59a7d75b4ea32575752362);

        return $this->valueHolder59a7d75b4e9fd701837375->clear($entityName);
    }
    ...
    {
        $this->initializer59a7d75b4ea32575752362 && $this->initializer59a7d75b4ea32575752362->__invoke($this->valueHolder59a7d75b4e9fd701837375, $this, 'close', array(), $this->initializer59a7d75b4ea32575752362);

        return $this->valueHolder59a7d75b4e9fd701837375->close();
    }
    ...
    {
        $this->initializer59a7d75b4ea32575752362 && $this->initializer59a7d75b4ea32575752362->__invoke($this->valueHolder59a7d75b4e9fd701837375, $this, 'persist', array('entity' => $entity), $this->initializer59a7d75b4ea32575752362);

        return $this->valueHolder59a7d75b4e9fd701837375->persist($entity);
    }
    ...
    {
        $this->initializer59a7d75b4ea32575752362 && $this->initializer59a7d75b4ea32575752362->__invoke($this->valueHolder59a7d75b4e9fd701837375, $this, 'remove', array('entity' => $entity), $this->initializer59a7d75b4ea32575752362);

        return $this->valueHolder59a7d75b4e9fd701837375->remove($entity);
    }
    ...
    {
        $this->initializer59a7d75b4ea32575752362 && $this->initializer59a7d75b4ea32575752362->__invoke($this->valueHolder59a7d75b4e9fd701837375, $this, 'refresh', array('entity' => $entity), $this->initializer59a7d75b4ea32575752362);

        return $this->valueHolder59a7d75b4e9fd701837375->refresh($entity);
    }
    ...
    {
        $this->initializer59a7d75b4ea32575752362 && $this->initializer59a7d75b4ea32575752362->__invoke($this->valueHolder59a7d75b4e9fd701837375, $this, 'detach', array('entity' => $entity), $this->initializer59a7d75b4ea32575752362);

        return $this->valueHolder59a7d75b4e9fd701837375->detach($entity);
    }
    ...
    {
        $this->initializer59a7d75b4ea32575752362 && $this->initializer59a7d75b4ea32575752362->__invoke($this->valueHolder59a7d75b4e9fd701837375, $this, 'merge', array('entity' => $entity), $this->initializer59a7d75b4ea32575752362);

        return $this->valueHolder59a7d75b4e9fd701837375->merge($entity);
    }
    ...
    {
        $this->initializer59a7d75b4ea32575752362 && $this->initializer59a7d75b4ea32575752362->__invoke($this->valueHolder59a7d75b4e9fd701837375, $this, 'copy', array('entity' => $entity, 'deep' => $deep), $this->initializer59a7d75b4ea32575752362);

        return $this->valueHolder59a7d75b4e9fd701837375->copy($entity, $deep);
    }
    ...
    {
        $this->initializer59a7d75b4ea32575752362 && $this->initializer59a7d75b4ea32575752362->__invoke($this->valueHolder59a7d75b4e9fd701837375, $this, 'lock', array('entity' => $entity, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer59a7d75b4ea32575752362);

        return $this->valueHolder59a7d75b4e9fd701837375->lock($entity, $lockMode, $lockVersion);
    }
    ...
    {
        $this->initializer59a7d75b4ea32575752362 && $this->initializer59a7d75b4ea32575752362->__invoke($this->valueHolder59a7d75b4e9fd701837375, $this, 'getRepository', array('entityName' => $entityName), $this->initializer59a7d75b4ea32575752362);

        return $this->valueHolder59a7d75b4e9fd701837375->getRepository($entityName);
    }
    ...
    {
        $this->initializer59a7d75b4ea32575752362 && $this->initializer59a7d75b4ea32575752362->__invoke($this->valueHolder59a7d75b4e9fd701837375, $this, 'contains', array('entity' => $entity), $this->initializer59a7d75b4ea32575752362);

        return $this->valueHolder59a7d75b4e9fd701837375->contains($entity);
    }
    ...
    {
        $this->initializer59a7d75b4ea32575752362 && $this->initializer59a7d75b4ea32575752362->__invoke($this->valueHolder59a7d75b4e9fd701837375, $this, 'getEventManager', array(), $this->initializer59a7d75b4ea32575752362);

        return $this->valueHolder59a7d75b4e9fd701837375->getEventManager();
    }
    ...
    {
        $this->initializer59a7d75b4ea32575752362 && $this->initializer59a7d75b4ea32575752362->__invoke($this->valueHolder59a7d75b4e9fd701837375, $this, 'getConfiguration', array(), $this->initializer59a7d75b4ea32575752362);

        return $this->valueHolder59a7d75b4e9fd701837375->getConfiguration();
    }
    ...
    {
        $this->initializer59a7d75b4ea32575752362 && $this->initializer59a7d75b4ea32575752362->__invoke($this->valueHolder59a7d75b4e9fd701837375, $this, 'isOpen', array(), $this->initializer59a7d75b4ea32575752362);

        return $this->valueHolder59a7d75b4e9fd701837375->isOpen();
    }
    ...
    {
        $this->initializer59a7d75b4ea32575752362 && $this->initializer59a7d75b4ea32575752362->__invoke($this->valueHolder59a7d75b4e9fd701837375, $this, 'getUnitOfWork', array(), $this->initializer59a7d75b4ea32575752362);

        return $this->valueHolder59a7d75b4e9fd701837375->getUnitOfWork();
    }
    ...
    {
        $this->initializer59a7d75b4ea32575752362 && $this->initializer59a7d75b4ea32575752362->__invoke($this->valueHolder59a7d75b4e9fd701837375, $this, 'getHydrator', array('hydrationMode' => $hydrationMode), $this->initializer59a7d75b4ea32575752362);

        return $this->valueHolder59a7d75b4e9fd701837375->getHydrator($hydrationMode);
    }
    ...
    {
        $this->initializer59a7d75b4ea32575752362 && $this->initializer59a7d75b4ea32575752362->__invoke($this->valueHolder59a7d75b4e9fd701837375, $this, 'newHydrator', array('hydrationMode' => $hydrationMode), $this->initializer59a7d75b4ea32575752362);

        return $this->valueHolder59a7d75b4e9fd701837375->newHydrator($hydrationMode);
    }
    ...
    {
        $this->initializer59a7d75b4ea32575752362 && $this->initializer59a7d75b4ea32575752362->__invoke($this->valueHolder59a7d75b4e9fd701837375, $this, 'getProxyFactory', array(), $this->initializer59a7d75b4ea32575752362);

        return $this->valueHolder59a7d75b4e9fd701837375->getProxyFactory();
    }
    ...
    {
        $this->initializer59a7d75b4ea32575752362 && $this->initializer59a7d75b4ea32575752362->__invoke($this->valueHolder59a7d75b4e9fd701837375, $this, 'initializeObject', array('obj' => $obj), $this->initializer59a7d75b4ea32575752362);

        return $this->valueHolder59a7d75b4e9fd701837375->initializeObject($obj);
    }
    ...
    {
        $this->initializer59a7d75b4ea32575752362 && $this->initializer59a7d75b4ea32575752362->__invoke($this->valueHolder59a7d75b4e9fd701837375, $this, 'getFilters', array(), $this->initializer59a7d75b4ea32575752362);

        return $this->valueHolder59a7d75b4e9fd701837375->getFilters();
    }
    ...
    {
        $this->initializer59a7d75b4ea32575752362 && $this->initializer59a7d75b4ea32575752362->__invoke($this->valueHolder59a7d75b4e9fd701837375, $this, 'isFiltersStateClean', array(), $this->initializer59a7d75b4ea32575752362);

        return $this->valueHolder59a7d75b4e9fd701837375->isFiltersStateClean();
    }
    ...
    {
        $this->initializer59a7d75b4ea32575752362 && $this->initializer59a7d75b4ea32575752362->__invoke($this->valueHolder59a7d75b4e9fd701837375, $this, 'hasFilters', array(), $this->initializer59a7d75b4ea32575752362);

        return $this->valueHolder59a7d75b4e9fd701837375->hasFilters();
    }
    ...
    {
        $this->initializer59a7d75b4ea32575752362 = $initializer;
    }
    ...
    {
        $this->initializer59a7d75b4ea32575752362 && $this->initializer59a7d75b4ea32575752362->__invoke($this->valueHolder59a7d75b4e9fd701837375, $this, '__get', array('name' => $name), $this->initializer59a7d75b4ea32575752362);

        if (isset(self::$publicProperties59a7d75b4e999026364405[$name])) {
            return $this->valueHolder59a7d75b4e9fd701837375->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder59a7d75b4e9fd701837375;
    ...
    {
        $this->initializer59a7d75b4ea32575752362 && $this->initializer59a7d75b4ea32575752362->__invoke($this->valueHolder59a7d75b4e9fd701837375, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer59a7d75b4ea32575752362);
    ...
    {
        $this->initializer59a7d75b4ea32575752362 && $this->initializer59a7d75b4ea32575752362->__invoke($this->valueHolder59a7d75b4e9fd701837375, $this, '__isset', array('name' => $name), $this->initializer59a7d75b4ea32575752362);
    ...
    {
        $this->initializer59a7d75b4ea32575752362 && $this->initializer59a7d75b4ea32575752362->__invoke($this->valueHolder59a7d75b4e9fd701837375, $this, '__unset', array('name' => $name), $this->initializer59a7d75b4ea32575752362);
    ...
    {
        $this->initializer59a7d75b4ea32575752362 && $this->initializer59a7d75b4ea32575752362->__invoke($this->valueHolder59a7d75b4e9fd701837375, $this, '__clone', array(), $this->initializer59a7d75b4ea32575752362);

        $this->valueHolder59a7d75b4e9fd701837375 = clone $this->valueHolder59a7d75b4e9fd701837375;
    }

    public function __sleep()
    {
        $this->initializer59a7d75b4ea32575752362 && $this->initializer59a7d75b4ea32575752362->__invoke($this->valueHolder59a7d75b4e9fd701837375, $this, '__sleep', array(), $this->initializer59a7d75b4ea32575752362);

        return array('valueHolder59a7d75b4e9fd701837375');
    }
    ...
    {
        return $this->initializer59a7d75b4ea32575752362;
    }
    ...
    {
        return $this->initializer59a7d75b4ea32575752362 && $this->initializer59a7d75b4ea32575752362->__invoke($this->valueHolder59a7d75b4e9fd701837375, $this, 'initializeProxy', array(), $this->initializer59a7d75b4ea32575752362);
    }
    ...
    {
        return null !== $this->valueHolder59a7d75b4e9fd701837375;
    }
    ...
    {
        return $this->valueHolder59a7d75b4e9fd701837375;
    }


}

class SymfonyComponentCacheAdapterFilesystemAdapter_000000000069a846000000003a267c96d7b741fef339d0f77c2ca74ea7f7d8e4 extends \Symfony\Component\Cache\Adapter\FilesystemAdapter implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder59a7d75b6b5d2420519301 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer59a7d75b6b602168865296 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties59a7d75b6b57a613932122 = array(
    ...
    {
        $this->initializer59a7d75b6b602168865296 && $this->initializer59a7d75b6b602168865296->__invoke($this->valueHolder59a7d75b6b5d2420519301, $this, 'getItem', array('key' => $key), $this->initializer59a7d75b6b602168865296);

        return $this->valueHolder59a7d75b6b5d2420519301->getItem($key);
    }
    ...
    {
        $this->initializer59a7d75b6b602168865296 && $this->initializer59a7d75b6b602168865296->__invoke($this->valueHolder59a7d75b6b5d2420519301, $this, 'getItems', array('keys' => $keys), $this->initializer59a7d75b6b602168865296);

        return $this->valueHolder59a7d75b6b5d2420519301->getItems($keys);
    }
    ...
    {
        $this->initializer59a7d75b6b602168865296 && $this->initializer59a7d75b6b602168865296->__invoke($this->valueHolder59a7d75b6b5d2420519301, $this, 'save', array('item' => $item), $this->initializer59a7d75b6b602168865296);

        return $this->valueHolder59a7d75b6b5d2420519301->save($item);
    }
    ...
    {
        $this->initializer59a7d75b6b602168865296 && $this->initializer59a7d75b6b602168865296->__invoke($this->valueHolder59a7d75b6b5d2420519301, $this, 'saveDeferred', array('item' => $item), $this->initializer59a7d75b6b602168865296);

        return $this->valueHolder59a7d75b6b5d2420519301->saveDeferred($item);
    }
    ...
    public function commit()
    {
        $this->initializer59a7d75b6b602168865296 && $this->initializer59a7d75b6b602168865296->__invoke($this->valueHolder59a7d75b6b5d2420519301, $this, 'commit', array(), $this->initializer59a7d75b6b602168865296);

        return $this->valueHolder59a7d75b6b5d2420519301->commit();
    }
    ...
    {
        $this->initializer59a7d75b6b602168865296 && $this->initializer59a7d75b6b602168865296->__invoke($this->valueHolder59a7d75b6b5d2420519301, $this, '__destruct', array(), $this->initializer59a7d75b6b602168865296);

        return $this->valueHolder59a7d75b6b5d2420519301->__destruct();
    }
    ...
    {
        $this->initializer59a7d75b6b602168865296 && $this->initializer59a7d75b6b602168865296->__invoke($this->valueHolder59a7d75b6b5d2420519301, $this, 'hasItem', array('key' => $key), $this->initializer59a7d75b6b602168865296);

        return $this->valueHolder59a7d75b6b5d2420519301->hasItem($key);
    }
    ...
    {
        $this->initializer59a7d75b6b602168865296 && $this->initializer59a7d75b6b602168865296->__invoke($this->valueHolder59a7d75b6b5d2420519301, $this, 'clear', array(), $this->initializer59a7d75b6b602168865296);

        return $this->valueHolder59a7d75b6b5d2420519301->clear();
    }
    ...
    {
        $this->initializer59a7d75b6b602168865296 && $this->initializer59a7d75b6b602168865296->__invoke($this->valueHolder59a7d75b6b5d2420519301, $this, 'deleteItem', array('key' => $key), $this->initializer59a7d75b6b602168865296);

        return $this->valueHolder59a7d75b6b5d2420519301->deleteItem($key);
    }
    ...
    {
        $this->initializer59a7d75b6b602168865296 && $this->initializer59a7d75b6b602168865296->__invoke($this->valueHolder59a7d75b6b5d2420519301, $this, 'deleteItems', array('keys' => $keys), $this->initializer59a7d75b6b602168865296);

        return $this->valueHolder59a7d75b6b5d2420519301->deleteItems($keys);
    }
    ...
    {
        $this->initializer59a7d75b6b602168865296 && $this->initializer59a7d75b6b602168865296->__invoke($this->valueHolder59a7d75b6b5d2420519301, $this, 'setLogger', array('logger' => $logger), $this->initializer59a7d75b6b602168865296);

        return $this->valueHolder59a7d75b6b5d2420519301->setLogger($logger);
    }
    ...
    public function __construct($initializer)
    {
        $this->initializer59a7d75b6b602168865296 = $initializer;
    }
    ...
    public function & __get($name)
    {
        $this->initializer59a7d75b6b602168865296 && $this->initializer59a7d75b6b602168865296->__invoke($this->valueHolder59a7d75b6b5d2420519301, $this, '__get', array('name' => $name), $this->initializer59a7d75b6b602168865296);

        if (isset(self::$publicProperties59a7d75b6b57a613932122[$name])) {
            return $this->valueHolder59a7d75b6b5d2420519301->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder59a7d75b6b5d2420519301;
    ...
    public function __set($name, $value)
    {
        $this->initializer59a7d75b6b602168865296 && $this->initializer59a7d75b6b602168865296->__invoke($this->valueHolder59a7d75b6b5d2420519301, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer59a7d75b6b602168865296);
    ...
    public function __isset($name)
    {
        $this->initializer59a7d75b6b602168865296 && $this->initializer59a7d75b6b602168865296->__invoke($this->valueHolder59a7d75b6b5d2420519301, $this, '__isset', array('name' => $name), $this->initializer59a7d75b6b602168865296);
    ...
    public function __unset($name)
    {
        $this->initializer59a7d75b6b602168865296 && $this->initializer59a7d75b6b602168865296->__invoke($this->valueHolder59a7d75b6b5d2420519301, $this, '__unset', array('name' => $name), $this->initializer59a7d75b6b602168865296);
    ...
    public function __clone()
    {
        $this->initializer59a7d75b6b602168865296 && $this->initializer59a7d75b6b602168865296->__invoke($this->valueHolder59a7d75b6b5d2420519301, $this, '__clone', array(), $this->initializer59a7d75b6b602168865296);

        $this->valueHolder59a7d75b6b5d2420519301 = clone $this->valueHolder59a7d75b6b5d2420519301;
    }

    public function __sleep()
    {
        $this->initializer59a7d75b6b602168865296 && $this->initializer59a7d75b6b602168865296->__invoke($this->valueHolder59a7d75b6b5d2420519301, $this, '__sleep', array(), $this->initializer59a7d75b6b602168865296);

        return array('valueHolder59a7d75b6b5d2420519301');
    }
    ...
    public function getProxyInitializer()
    {
        return $this->initializer59a7d75b6b602168865296;
    }
    ...
    public function initializeProxy()
    {
        return $this->initializer59a7d75b6b602168865296 && $this->initializer59a7d75b6b602168865296->__invoke($this->valueHolder59a7d75b6b5d2420519301, $this, 'initializeProxy', array(), $this->initializer59a7d75b6b602168865296);
    }
    ...
    public function isProxyInitialized()
    {
        return null !== $this->valueHolder59a7d75b6b5d2420519301;
    }
    ...
    public function getWrappedValueHolderValue()
    {
        return $this->valueHolder59a7d75b6b5d2420519301;
    }

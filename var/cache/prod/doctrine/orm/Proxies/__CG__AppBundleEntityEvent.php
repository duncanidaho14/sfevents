...
class Event extends \AppBundle\Entity\Event implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Event' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Event' . "\0" . 'name', '' . "\0" . 'AppBundle\\Entity\\Event' . "\0" . 'location', '' . "\0" . 'AppBundle\\Entity\\Event' . "\0" . 'price', '' . "\0" . 'AppBundle\\Entity\\Event' . "\0" . 'description', '' . "\0" . 'AppBundle\\Entity\\Event' . "\0" . 'startsAt'];
        }

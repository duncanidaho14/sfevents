...
class appProdProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->aliases = array(
            ...
            'markdown_cache' => 'doctrine_cache.providers.my_markdown_cache',
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('HODVjuM90R', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('97xHA+QIRE', 0, 'NQmgrW2Q2x81Omr7HiTY9J', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'eventbrote', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), new \Doctrine\DBAL\Configuration(), $a, array());
    }
    ...
    public function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['doctrine.orm.default_entity_manager'] = new DoctrineORMEntityManager_0000000034a731ef0000000056cb7679533c1c15f164a2d36aa402538094bcfa(
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_5c964d3503e14fd9c43346c2d0584feac10d60e21af026bc275dbc3246d9f375');
    ...
    {
        return $this->services['doctrine_cache.providers.my_markdown_cache'] = new \Doctrine\Common\Cache\FilesystemCache((__DIR__.'/doctrine/cache/file_system'), NULL, 2);
    }
    ...
    {
        return $this->services['property_accessor'] = new \Symfony\Component\PropertyAccess\PropertyAccessor(false, false, \Symfony\Component\PropertyAccess\PropertyAccessor::createCache('n-KKC3-iwX', NULL, 'NQmgrW2Q2x81Omr7HiTY9J', $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)));
    }
    ...
    {
        return $this->services['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Pz0NJJnDph', 0, 'NQmgrW2Q2x81Omr7HiTY9J', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['cache.validator'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('8ey0Hbfy1E', 0, 'NQmgrW2Q2x81Omr7HiTY9J', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('5935226a5b38f1.17519207')), true);
...
class DoctrineORMEntityManager_0000000034a731ef0000000056cb7679533c1c15f164a2d36aa402538094bcfa extends \Doctrine\ORM\EntityManager implements \ProxyManager\Proxy\VirtualProxyInterface
{
    private $valueHolder5935226c57a1a469215411 = null;
    private $initializer5935226c57a27255884911 = null;
    private static $publicProperties5935226c579f7470842847 = array(
        
    );
    public function getConnection()
    {
        $this->initializer5935226c57a27255884911 && $this->initializer5935226c57a27255884911->__invoke($this->valueHolder5935226c57a1a469215411, $this, 'getConnection', array(), $this->initializer5935226c57a27255884911);
        return $this->valueHolder5935226c57a1a469215411->getConnection();
    }
    public function getMetadataFactory()
    {
        $this->initializer5935226c57a27255884911 && $this->initializer5935226c57a27255884911->__invoke($this->valueHolder5935226c57a1a469215411, $this, 'getMetadataFactory', array(), $this->initializer5935226c57a27255884911);
        return $this->valueHolder5935226c57a1a469215411->getMetadataFactory();
    }
    public function getExpressionBuilder()
    {
        $this->initializer5935226c57a27255884911 && $this->initializer5935226c57a27255884911->__invoke($this->valueHolder5935226c57a1a469215411, $this, 'getExpressionBuilder', array(), $this->initializer5935226c57a27255884911);
        return $this->valueHolder5935226c57a1a469215411->getExpressionBuilder();
    }
    public function beginTransaction()
    {
        $this->initializer5935226c57a27255884911 && $this->initializer5935226c57a27255884911->__invoke($this->valueHolder5935226c57a1a469215411, $this, 'beginTransaction', array(), $this->initializer5935226c57a27255884911);
        return $this->valueHolder5935226c57a1a469215411->beginTransaction();
    }
    public function getCache()
    {
        $this->initializer5935226c57a27255884911 && $this->initializer5935226c57a27255884911->__invoke($this->valueHolder5935226c57a1a469215411, $this, 'getCache', array(), $this->initializer5935226c57a27255884911);
        return $this->valueHolder5935226c57a1a469215411->getCache();
    }
    public function transactional($func)
    {
        $this->initializer5935226c57a27255884911 && $this->initializer5935226c57a27255884911->__invoke($this->valueHolder5935226c57a1a469215411, $this, 'transactional', array('func' => $func), $this->initializer5935226c57a27255884911);
        return $this->valueHolder5935226c57a1a469215411->transactional($func);
    }
    public function commit()
    {
        $this->initializer5935226c57a27255884911 && $this->initializer5935226c57a27255884911->__invoke($this->valueHolder5935226c57a1a469215411, $this, 'commit', array(), $this->initializer5935226c57a27255884911);
        return $this->valueHolder5935226c57a1a469215411->commit();
    }
    public function rollback()
    {
        $this->initializer5935226c57a27255884911 && $this->initializer5935226c57a27255884911->__invoke($this->valueHolder5935226c57a1a469215411, $this, 'rollback', array(), $this->initializer5935226c57a27255884911);
        return $this->valueHolder5935226c57a1a469215411->rollback();
    }
    public function getClassMetadata($className)
    {
        $this->initializer5935226c57a27255884911 && $this->initializer5935226c57a27255884911->__invoke($this->valueHolder5935226c57a1a469215411, $this, 'getClassMetadata', array('className' => $className), $this->initializer5935226c57a27255884911);
        return $this->valueHolder5935226c57a1a469215411->getClassMetadata($className);
    }
    public function createQuery($dql = '')
    {
        $this->initializer5935226c57a27255884911 && $this->initializer5935226c57a27255884911->__invoke($this->valueHolder5935226c57a1a469215411, $this, 'createQuery', array('dql' => $dql), $this->initializer5935226c57a27255884911);
        return $this->valueHolder5935226c57a1a469215411->createQuery($dql);
    }
    public function createNamedQuery($name)
    {
        $this->initializer5935226c57a27255884911 && $this->initializer5935226c57a27255884911->__invoke($this->valueHolder5935226c57a1a469215411, $this, 'createNamedQuery', array('name' => $name), $this->initializer5935226c57a27255884911);
        return $this->valueHolder5935226c57a1a469215411->createNamedQuery($name);
    }
    public function createNativeQuery($sql, \Doctrine\ORM\Query\ResultSetMapping $rsm)
    {
        $this->initializer5935226c57a27255884911 && $this->initializer5935226c57a27255884911->__invoke($this->valueHolder5935226c57a1a469215411, $this, 'createNativeQuery', array('sql' => $sql, 'rsm' => $rsm), $this->initializer5935226c57a27255884911);
        return $this->valueHolder5935226c57a1a469215411->createNativeQuery($sql, $rsm);
    }
    public function createNamedNativeQuery($name)
    {
        $this->initializer5935226c57a27255884911 && $this->initializer5935226c57a27255884911->__invoke($this->valueHolder5935226c57a1a469215411, $this, 'createNamedNativeQuery', array('name' => $name), $this->initializer5935226c57a27255884911);
        return $this->valueHolder5935226c57a1a469215411->createNamedNativeQuery($name);
    }
    public function createQueryBuilder()
    {
        $this->initializer5935226c57a27255884911 && $this->initializer5935226c57a27255884911->__invoke($this->valueHolder5935226c57a1a469215411, $this, 'createQueryBuilder', array(), $this->initializer5935226c57a27255884911);
        return $this->valueHolder5935226c57a1a469215411->createQueryBuilder();
    }
    public function flush($entity = null)
    {
        $this->initializer5935226c57a27255884911 && $this->initializer5935226c57a27255884911->__invoke($this->valueHolder5935226c57a1a469215411, $this, 'flush', array('entity' => $entity), $this->initializer5935226c57a27255884911);
        return $this->valueHolder5935226c57a1a469215411->flush($entity);
    }
    public function find($entityName, $id, $lockMode = null, $lockVersion = null)
    {
        $this->initializer5935226c57a27255884911 && $this->initializer5935226c57a27255884911->__invoke($this->valueHolder5935226c57a1a469215411, $this, 'find', array('entityName' => $entityName, 'id' => $id, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer5935226c57a27255884911);
        return $this->valueHolder5935226c57a1a469215411->find($entityName, $id, $lockMode, $lockVersion);
    }
    public function getReference($entityName, $id)
    {
        $this->initializer5935226c57a27255884911 && $this->initializer5935226c57a27255884911->__invoke($this->valueHolder5935226c57a1a469215411, $this, 'getReference', array('entityName' => $entityName, 'id' => $id), $this->initializer5935226c57a27255884911);
        return $this->valueHolder5935226c57a1a469215411->getReference($entityName, $id);
    }
    public function getPartialReference($entityName, $identifier)
    {
        $this->initializer5935226c57a27255884911 && $this->initializer5935226c57a27255884911->__invoke($this->valueHolder5935226c57a1a469215411, $this, 'getPartialReference', array('entityName' => $entityName, 'identifier' => $identifier), $this->initializer5935226c57a27255884911);
        return $this->valueHolder5935226c57a1a469215411->getPartialReference($entityName, $identifier);
    }
    public function clear($entityName = null)
    {
        $this->initializer5935226c57a27255884911 && $this->initializer5935226c57a27255884911->__invoke($this->valueHolder5935226c57a1a469215411, $this, 'clear', array('entityName' => $entityName), $this->initializer5935226c57a27255884911);
        return $this->valueHolder5935226c57a1a469215411->clear($entityName);
    }
    public function close()
    {
        $this->initializer5935226c57a27255884911 && $this->initializer5935226c57a27255884911->__invoke($this->valueHolder5935226c57a1a469215411, $this, 'close', array(), $this->initializer5935226c57a27255884911);
        return $this->valueHolder5935226c57a1a469215411->close();
    }
    public function persist($entity)
    {
        $this->initializer5935226c57a27255884911 && $this->initializer5935226c57a27255884911->__invoke($this->valueHolder5935226c57a1a469215411, $this, 'persist', array('entity' => $entity), $this->initializer5935226c57a27255884911);
        return $this->valueHolder5935226c57a1a469215411->persist($entity);
    }
    public function remove($entity)
    {
        $this->initializer5935226c57a27255884911 && $this->initializer5935226c57a27255884911->__invoke($this->valueHolder5935226c57a1a469215411, $this, 'remove', array('entity' => $entity), $this->initializer5935226c57a27255884911);
        return $this->valueHolder5935226c57a1a469215411->remove($entity);
    }
    public function refresh($entity)
    {
        $this->initializer5935226c57a27255884911 && $this->initializer5935226c57a27255884911->__invoke($this->valueHolder5935226c57a1a469215411, $this, 'refresh', array('entity' => $entity), $this->initializer5935226c57a27255884911);
        return $this->valueHolder5935226c57a1a469215411->refresh($entity);
    }
    public function detach($entity)
    {
        $this->initializer5935226c57a27255884911 && $this->initializer5935226c57a27255884911->__invoke($this->valueHolder5935226c57a1a469215411, $this, 'detach', array('entity' => $entity), $this->initializer5935226c57a27255884911);
        return $this->valueHolder5935226c57a1a469215411->detach($entity);
    }
    public function merge($entity)
    {
        $this->initializer5935226c57a27255884911 && $this->initializer5935226c57a27255884911->__invoke($this->valueHolder5935226c57a1a469215411, $this, 'merge', array('entity' => $entity), $this->initializer5935226c57a27255884911);
        return $this->valueHolder5935226c57a1a469215411->merge($entity);
    }
    public function copy($entity, $deep = false)
    {
        $this->initializer5935226c57a27255884911 && $this->initializer5935226c57a27255884911->__invoke($this->valueHolder5935226c57a1a469215411, $this, 'copy', array('entity' => $entity, 'deep' => $deep), $this->initializer5935226c57a27255884911);
        return $this->valueHolder5935226c57a1a469215411->copy($entity, $deep);
    }
    public function lock($entity, $lockMode, $lockVersion = null)
    {
        $this->initializer5935226c57a27255884911 && $this->initializer5935226c57a27255884911->__invoke($this->valueHolder5935226c57a1a469215411, $this, 'lock', array('entity' => $entity, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer5935226c57a27255884911);
        return $this->valueHolder5935226c57a1a469215411->lock($entity, $lockMode, $lockVersion);
    }
    public function getRepository($entityName)
    {
        $this->initializer5935226c57a27255884911 && $this->initializer5935226c57a27255884911->__invoke($this->valueHolder5935226c57a1a469215411, $this, 'getRepository', array('entityName' => $entityName), $this->initializer5935226c57a27255884911);
        return $this->valueHolder5935226c57a1a469215411->getRepository($entityName);
    }
    public function contains($entity)
    {
        $this->initializer5935226c57a27255884911 && $this->initializer5935226c57a27255884911->__invoke($this->valueHolder5935226c57a1a469215411, $this, 'contains', array('entity' => $entity), $this->initializer5935226c57a27255884911);
        return $this->valueHolder5935226c57a1a469215411->contains($entity);
    }
    public function getEventManager()
    {
        $this->initializer5935226c57a27255884911 && $this->initializer5935226c57a27255884911->__invoke($this->valueHolder5935226c57a1a469215411, $this, 'getEventManager', array(), $this->initializer5935226c57a27255884911);
        return $this->valueHolder5935226c57a1a469215411->getEventManager();
    }
    public function getConfiguration()
    {
        $this->initializer5935226c57a27255884911 && $this->initializer5935226c57a27255884911->__invoke($this->valueHolder5935226c57a1a469215411, $this, 'getConfiguration', array(), $this->initializer5935226c57a27255884911);
        return $this->valueHolder5935226c57a1a469215411->getConfiguration();
    }
    public function isOpen()
    {
        $this->initializer5935226c57a27255884911 && $this->initializer5935226c57a27255884911->__invoke($this->valueHolder5935226c57a1a469215411, $this, 'isOpen', array(), $this->initializer5935226c57a27255884911);
        return $this->valueHolder5935226c57a1a469215411->isOpen();
    }
    public function getUnitOfWork()
    {
        $this->initializer5935226c57a27255884911 && $this->initializer5935226c57a27255884911->__invoke($this->valueHolder5935226c57a1a469215411, $this, 'getUnitOfWork', array(), $this->initializer5935226c57a27255884911);
        return $this->valueHolder5935226c57a1a469215411->getUnitOfWork();
    }
    public function getHydrator($hydrationMode)
    {
        $this->initializer5935226c57a27255884911 && $this->initializer5935226c57a27255884911->__invoke($this->valueHolder5935226c57a1a469215411, $this, 'getHydrator', array('hydrationMode' => $hydrationMode), $this->initializer5935226c57a27255884911);
        return $this->valueHolder5935226c57a1a469215411->getHydrator($hydrationMode);
    }
    public function newHydrator($hydrationMode)
    {
        $this->initializer5935226c57a27255884911 && $this->initializer5935226c57a27255884911->__invoke($this->valueHolder5935226c57a1a469215411, $this, 'newHydrator', array('hydrationMode' => $hydrationMode), $this->initializer5935226c57a27255884911);
        return $this->valueHolder5935226c57a1a469215411->newHydrator($hydrationMode);
    }
    public function getProxyFactory()
    {
        $this->initializer5935226c57a27255884911 && $this->initializer5935226c57a27255884911->__invoke($this->valueHolder5935226c57a1a469215411, $this, 'getProxyFactory', array(), $this->initializer5935226c57a27255884911);
        return $this->valueHolder5935226c57a1a469215411->getProxyFactory();
    }
    public function initializeObject($obj)
    {
        $this->initializer5935226c57a27255884911 && $this->initializer5935226c57a27255884911->__invoke($this->valueHolder5935226c57a1a469215411, $this, 'initializeObject', array('obj' => $obj), $this->initializer5935226c57a27255884911);
        return $this->valueHolder5935226c57a1a469215411->initializeObject($obj);
    }
    public function getFilters()
    {
        $this->initializer5935226c57a27255884911 && $this->initializer5935226c57a27255884911->__invoke($this->valueHolder5935226c57a1a469215411, $this, 'getFilters', array(), $this->initializer5935226c57a27255884911);
        return $this->valueHolder5935226c57a1a469215411->getFilters();
    }
    public function isFiltersStateClean()
    {
        $this->initializer5935226c57a27255884911 && $this->initializer5935226c57a27255884911->__invoke($this->valueHolder5935226c57a1a469215411, $this, 'isFiltersStateClean', array(), $this->initializer5935226c57a27255884911);
        return $this->valueHolder5935226c57a1a469215411->isFiltersStateClean();
    }
    public function hasFilters()
    {
        $this->initializer5935226c57a27255884911 && $this->initializer5935226c57a27255884911->__invoke($this->valueHolder5935226c57a1a469215411, $this, 'hasFilters', array(), $this->initializer5935226c57a27255884911);
        return $this->valueHolder5935226c57a1a469215411->hasFilters();
    }
    public function __construct($initializer)
    {
        $this->initializer5935226c57a27255884911 = $initializer;
    }
    public function & __get($name)
    {
        $this->initializer5935226c57a27255884911 && $this->initializer5935226c57a27255884911->__invoke($this->valueHolder5935226c57a1a469215411, $this, '__get', array('name' => $name), $this->initializer5935226c57a27255884911);
        if (isset(self::$publicProperties5935226c579f7470842847[$name])) {
            return $this->valueHolder5935226c57a1a469215411->$name;
        }
        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));
        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5935226c57a1a469215411;
    ...
    {
        $this->initializer5935226c57a27255884911 && $this->initializer5935226c57a27255884911->__invoke($this->valueHolder5935226c57a1a469215411, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5935226c57a27255884911);
        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));
        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5935226c57a1a469215411;
    ...
    {
        $this->initializer5935226c57a27255884911 && $this->initializer5935226c57a27255884911->__invoke($this->valueHolder5935226c57a1a469215411, $this, '__isset', array('name' => $name), $this->initializer5935226c57a27255884911);
        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));
        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5935226c57a1a469215411;
    ...
    {
        $this->initializer5935226c57a27255884911 && $this->initializer5935226c57a27255884911->__invoke($this->valueHolder5935226c57a1a469215411, $this, '__unset', array('name' => $name), $this->initializer5935226c57a27255884911);
        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));
        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5935226c57a1a469215411;
    ...
    {
        $this->initializer5935226c57a27255884911 && $this->initializer5935226c57a27255884911->__invoke($this->valueHolder5935226c57a1a469215411, $this, '__clone', array(), $this->initializer5935226c57a27255884911);
        $this->valueHolder5935226c57a1a469215411 = clone $this->valueHolder5935226c57a1a469215411;
    }
    public function __sleep()
    {
        $this->initializer5935226c57a27255884911 && $this->initializer5935226c57a27255884911->__invoke($this->valueHolder5935226c57a1a469215411, $this, '__sleep', array(), $this->initializer5935226c57a27255884911);
        return array('valueHolder5935226c57a1a469215411');
    }
    ...
    {
        return $this->initializer5935226c57a27255884911;
    }
    public function initializeProxy()
    {
        return $this->initializer5935226c57a27255884911 && $this->initializer5935226c57a27255884911->__invoke($this->valueHolder5935226c57a1a469215411, $this, 'initializeProxy', array(), $this->initializer5935226c57a27255884911);
    }
    public function isProxyInitialized()
    {
        return null !== $this->valueHolder5935226c57a1a469215411;
    }
    public function getWrappedValueHolderValue()
    {
        return $this->valueHolder5935226c57a1a469215411;
    }
}
